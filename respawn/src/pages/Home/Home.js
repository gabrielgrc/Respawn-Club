      ...
      <Footer2 />
        ...
        <div className="content">
          <div className="card text-center">
            ...
            <img src={velocimetro} alt="picture description" width="450" />
          </div>

          <div className="card text-center">
            <h2>Gostos</h2>
            <p>
              Não interessa a cilindrada, e sim <strong>a sua vontade</strong>
            </p>
            <img src={gostos} alt="picture description" width="450" />
          </div>
          ...
          <div className="card text-center">
            ...
            <p>
              ...
              <strong>
                "todo motoqueiro cai e pilota sem respeitar os outros"
              </strong>
            </p>
            <img src={paradigma} alt="picture description" width="450" />
          </div>
